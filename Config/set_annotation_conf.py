...
def set_voc_tags(tree, folder, filename, path, size, width, height, depth, obj, obj_name, box, x0, y0, x1, y1,
                 conf_file='voc_conf.json', indent=4, sort_keys=False):
    """
    ...
    conf = {'Tree': {'Tree Tag': tree, 'Folder': folder, 'Filename': filename, 'Path': path},
            ...
            'Object': {'Object Tag': obj, 'Object Name': obj_name, 'Object Box': {
                'Object Box Tag': box, 'X0': x0, 'Y0': y0, 'X1': x1, 'Y1': y1}}}
